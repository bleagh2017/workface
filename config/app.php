...
return [
    ...
    */
    ...
    //小程序配置
    'appid' => "wxae805cb4f5aa6b47",
//    'appid' => "wxa5d095364038fec2",//旧
    'secret' => "e14ba92a420e6304452ee817525f3801",
//    'secret' => "132a8eb60e3c3ce12f7c178ca1d3c455",//旧
    
    //sendCloud
    'api_key' => "NHYiimFXiVMkhh72",
    
    //微信jscode2session 接口地址
    ...
    //付费番外活动消息模板
    "payedEvent" => "6hm6xBumQtO1wDjZA4BvREw1pgAbhHLKMD6Km3XJGfU",
    //普通活动消息模板
    "normalEvent" => "6hm6xBumQtO1wDjZA4BvRJNTYLn0rBgfMozkmKgqnno",
    //报名失败模板
    "falieEvent" => "GD3mpFRC-ZZp9iGNaZTq1XqIqRCvo5NXMGRXcz381dg",
